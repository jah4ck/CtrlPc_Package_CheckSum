...
namespace CtrlPc_Package_CheckSum.Tools.CheckSum
{
    class AD_CheckSum_Tools
    {
        public static string GetFile_CheckSum(string HashType, string File_To_Check)
        {
            ...
            try
            {
                if (System.IO.File.Exists(File_To_Check))
                {
                    ...
                    Console.WriteLine("CheckSum File " + File_To_Check + " = " + _File_CheckSum + " pour HashType = " + HashType + "");

                    return _File_CheckSum.ToLower();
                }
                else
                {
                    Console.WriteLine("File " + File_To_Check + " Inexistant !!!");
                }
            }
        ...
        public static bool IsValid_File_CheckSum(string File_To_Check)
        {
            ...
            try
            {
                Console.WriteLine("Contrôle CheckSum File " + File_To_Check + " ...");
                ...
                Console.WriteLine("Valeur CheckSum Récupéré = " + _File_To_Check_CheckSum + " dans File " + File_To_Check);
                ...
                if (_File_To_Check_CheckSum.Length == 32)
                {
                    ...
                    {
                        Console.WriteLine("CheckSum File " + File_To_Check + " Is Valid");

                        _CheckSum_Return = true;
                    }
                    else
                    {
                        Console.WriteLine("CheckSum File " + File_To_Check + " Is Not Valid");
                    }
                }
                else
                {
                    Console.WriteLine( "Valeur CheckSum Récupéré = " + _File_To_Check_CheckSum + " Incorrecte !!!");
                }
